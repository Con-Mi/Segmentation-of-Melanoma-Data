...
def get_id_csv_files():
    # Training data
    list_ids_train_input = [f for f in listdir("../data/MelanomaData/ISIC2018_Task1-2_Training_Input")]
    list_ids_train_labels = [f for f in listdir("../data/MelanomaData/ISIC2018_Task1_Training_GroundTruth")]
    ...
    train_input_df.to_csv("../data/MelanomaData/train_input_ids.csv")
    train_labels_df.to_csv("../data/MelanomaData/train_labels_ids.csv")

    # Test Validation Data
    list_ids_valid_input = [f for f in listdir("../data/MelanomaData/ISIC2018_Task1-2_Validation_Input")]
    ...
    valid_input_df.to_csv("../data/MelanomaData/valid_input_ids.csv")

    # Test Data
    list_ids_test_input = [f for f in listdir("../data/MelanomaData/ISIC2018_Task1-2_Test_Input")]
    ...
    test_input_df.to_csv("../data/MelanomaData/test_input_ids.csv")
