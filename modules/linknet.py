...
class LinkNet(nn.Module):
    def __init__(self, num_classes, num_input_channels, num_filters = 32, transp=False, pretrained=True):
        ...
        self.dec5 = Upsample(2048 + num_filters*8, num_filters*8, num_filters*8) # 32
        self.dec4 = Upsample(1024 + num_filters*8, num_filters*8, num_filters*8) # 64
        self.dec3 = Upsample(512 + num_filters*8, num_filters*2, num_filters*2)  # 128
        self.dec2 = Upsample(256 + num_filters*2, num_filters*2, num_filters*2)  # 256
...
def linknet_model(num_classes=1, num_input_channels=3):
